...
class EmoteWSHandler:
    ...
    def __init__(self, ws_handler: Optional["WebSocketHandler"] = None) -> None:
        """
        初始化处理器
        ...
        self._manager: Optional[EmoteManager] = None
...
# 全局处理器实例
_emote_ws_handler: Optional[EmoteWSHandler] = None
