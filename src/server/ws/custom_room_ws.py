...
class AIFillRoomMessage(BaseMessage):
    ...
    count: Optional[int] = Field(default=None, description="填充数量")
...
class CustomRoomWSHandler:
    ...
    async def handle_get_room_list(
        ...
        try:
            ...
            room_summaries = [
                self._room_to_summary_data(room)
    ...
    async def _notify_player_joined(
        ...
        player_ids = [
            ...
            if pid != player_id and not pid.startswith("ai_")
        ]
