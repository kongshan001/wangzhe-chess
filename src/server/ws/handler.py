...
class SessionManager:
    ...
    def get_sessions_in_room(self, room_id: str) -> list[Session]:
        ...
        Returns:
            会话列表
        """
        return [session for session in self._sessions.values() if session.room_id == room_id]

    def set_player_room(self, player_id: str, room_id: str | None) -> None:
        """
        设置玩家所在房间
...
class WebSocketHandler:
    ...
    def __init__(self) -> None:
        ...
        self._room_handler: RoomWSHandler | None = None
