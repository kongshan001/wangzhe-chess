...
class AchievementManager:
    ...
    def __init__(self, config_path: str | None = None):
        ...
        self.player_achievements: dict[
            str, PlayerAchievement
    ...
    def update_progress(
        ...
        **kwargs,
        ...
        if just_completed:
            logger.info(f"Player {player_id} completed achievement: {achievement.name}")
    ...
    def claim_reward(
        ...
        if player_achievement.claim_reward():
            logger.info(f"Player {player_id} claimed reward for achievement: {achievement.name}")
    ...
    def get_player_achievements(
        ...
        for achievement in self.achievements.values():
            ...
            achievement_data["player_progress"] = (
                player_achievement.to_dict()
    ...
    def get_recently_completed(
        ...
        for achievement in self.achievements.values():
            ...
            if (
                player_achievement
                and player_achievement.completed
                and player_achievement.completed_at
            ):
                completed.append(
                    {
...
def get_achievement_manager(config_path: str | None = None) -> AchievementManager:
    """
    获取成就管理器单例
