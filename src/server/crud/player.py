...
class PlayerCRUD(CacheMixin):
    ...
    async def get_by_id(self, player_id: int) -> PlayerDB | None:
        """
        通过ID获取玩家
    ...
    async def get_by_user_id(self, user_id: str) -> PlayerDB | None:
        """
        通过用户ID获取玩家
    ...
    async def get_by_username(self, username: str) -> PlayerDB | None:
        """
        通过用户名获取玩家
    ...
    async def get_by_device_id(self, device_id: str) -> PlayerDB | None:
        """
        通过设备ID获取玩家
    ...
    async def update_nickname(self, player_id: int, nickname: str) -> PlayerDB | None:
        """
        更新昵称
    ...
    async def get_rank(self, player_id: int) -> PlayerRankDB | None:
        """
        获取玩家段位信息
    ...
    async def get_stats(self, player_id: int) -> PlayerStatsDB | None:
        """
        获取玩家统计数据
