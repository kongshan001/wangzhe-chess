...
class CustomRoomFilter:
    ...
    state: Optional[CustomRoomState] = None
    has_space: Optional[bool] = None
    has_password: Optional[bool] = None
    min_players: Optional[int] = None
    max_players: Optional[int] = None
    special_rules: Optional[List[SpecialRuleType]] = None
...
class CustomRoomManager:
    ...
    _instance: Optional["CustomRoomManager"] = None
    ...
    def __init__(self) -> None:
        ...
        # 回调函数
        self._on_room_created: Optional[Callable[[CustomRoom], None]] = None
        self._on_room_destroyed: Optional[Callable[[str], None]] = None
        self._on_player_join: Optional[Callable[[str, str, CustomRoom], None]] = None
        self._on_player_leave: Optional[Callable[[str, str, CustomRoom], None]] = None
        self._on_player_kicked: Optional[Callable[[str, str, CustomRoom], None]] = None
        self._on_game_start: Optional[Callable[[CustomRoom], None]] = None
        self._on_room_updated: Optional[Callable[[CustomRoom], None]] = None
    ...
    async def get_room(self, room_id: str) -> Optional[CustomRoom]:
        """获取指定房间"""
    ...
    async def get_player_room(self, player_id: str) -> Optional[CustomRoom]:
        """获取玩家所在的房间"""
        room_id = self.player_rooms.get(player_id)
        if not room_id:
            return None
    ...
    def __repr__(self) -> str:
        return (
            f"<CustomRoomManager(rooms={len(self.rooms)}, "
