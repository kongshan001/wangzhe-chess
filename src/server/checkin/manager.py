...
class CheckinManager:
    ...
    def _init_default_rewards(self) -> None:
        ...
        default_daily = [
            ...
            DailyRewardConfig(
                ...
                base_rewards=[
                    ...
                    CheckinReward(
                        reward_id="day2_fragment", reward_type=RewardType.HERO_FRAGMENT, quantity=5
                    ),
                ],
            ),
            DailyRewardConfig(
            ...
            DailyRewardConfig(
                ...
                base_rewards=[
                    ...
                    CheckinReward(
                        reward_id="day4_fragment", reward_type=RewardType.HERO_FRAGMENT, quantity=10
                    ),
                ],
            ),
            DailyRewardConfig(
                ...
                bonus_rewards=[
                    CheckinReward(
                        reward_id="day5_diamond", reward_type=RewardType.DIAMOND, quantity=10
                    ),
                ],
            ),
            DailyRewardConfig(
                ...
                base_rewards=[
                    ...
                    CheckinReward(
                        reward_id="day6_fragment", reward_type=RewardType.HERO_FRAGMENT, quantity=15
                    ),
                ],
            ),
            DailyRewardConfig(
                ...
                bonus_rewards=[
                    CheckinReward(
                        reward_id="day7_diamond", reward_type=RewardType.DIAMOND, quantity=30
                    ),
                    CheckinReward(
                        reward_id="day7_skin",
                        reward_type=RewardType.SKIN,
                        item_id="random_skin_box",
                        quantity=1,
                    ),
                ],
            ),
        ...
        default_monthly = [
            DailyRewardConfig(
                ...
                base_rewards=[
                    CheckinReward(
                        reward_id="month7_gold", reward_type=RewardType.GOLD, quantity=500
                    ),
                    CheckinReward(
                        reward_id="month7_diamond", reward_type=RewardType.DIAMOND, quantity=20
                    ),
                ],
            ),
            DailyRewardConfig(
                ...
                base_rewards=[
                    CheckinReward(
                        reward_id="month14_gold", reward_type=RewardType.GOLD, quantity=1000
                    ),
                    CheckinReward(
                        reward_id="month14_fragment",
            ...
            DailyRewardConfig(
                ...
                base_rewards=[
                    CheckinReward(
                        reward_id="month21_gold", reward_type=RewardType.GOLD, quantity=1500
                    ),
                    CheckinReward(
                        reward_id="month21_diamond", reward_type=RewardType.DIAMOND, quantity=50
                    ),
                ],
            ),
            DailyRewardConfig(
                ...
                base_rewards=[
                    CheckinReward(
                        reward_id="month30_gold", reward_type=RewardType.GOLD, quantity=3000
                    ),
                    CheckinReward(
                        reward_id="month30_diamond", reward_type=RewardType.DIAMOND, quantity=100
                    ),
                    CheckinReward(
                        reward_id="month30_skin",
                        reward_type=RewardType.SKIN,
                        item_id="month_skin_box",
                        quantity=1,
                    ),
                ],
            ),
    ...
    def get_daily_rewards(
        self, cycle_day: int, streak_days: int
    ) -> tuple[list[CheckinReward], list[CheckinReward]]:
        """
        获取指定天数的签到奖励
    ...
    def checkin(self, player_id: str) -> tuple[CheckinRecord | None, str | None]:
        """
        执行每日签到
    ...
    def supplement_checkin(
        ...
        target_date: date,
        diamond_balance: int,
    ) -> tuple[CheckinRecord | None, int, str | None]:
        """
        执行补签
        ...
        logger.info(f"Player {player_id} supplement checked in: date={target_date}, cost={cost}")
    ...
    def get_reward_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "monthly_rewards": {
                day: config.to_dict() for day, config in self.monthly_rewards.items()
            },
...
# 全局单例
_checkin_manager: CheckinManager | None = None


def get_checkin_manager(config_path: str | None = None) -> CheckinManager:
    """
    获取签到管理器单例
