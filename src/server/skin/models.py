...
class Skin:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> Skin:
        ...
        return cls(
            ...
            price=price,
            stat_bonuses=[
                SkinStatBonus.from_dict(b) for b in data.get("stat_bonuses", [])
            ],
            effects=[
                SkinEffect.from_dict(e) for e in data.get("effects", [])
            ],
...
class PlayerSkin:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> PlayerSkin:
        ...
        return cls(
            ...
            equipped_at=datetime.fromisoformat(data["equipped_at"]) if data.get("equipped_at") else None,
        )
