...
class FriendInfo:
    ...
    in_game_info: Optional[Dict[str, Any]] = None
...
class FriendRequestData:
    ...
    @staticmethod
    def from_request(request: FriendRequest, from_nickname: str = "", from_avatar: str = "") -> Dict[str, Any]:
...
class PrivateMessageData:
    ...
    @staticmethod
    def from_message(msg: PrivateMessage, from_nickname: str = "", from_avatar: str = "") -> Dict[str, Any]:
