...
class LeaderboardManager:
    ...
    DEFAULT_REWARDS: List[LeaderboardReward] = [
        ...
        LeaderboardReward(
            ...
            gold=5000, exp=10000, title="荣耀王者",
            avatar_frame="rank_1_frame"
        ),
        # 第2-3名
        LeaderboardReward(
            rank_start=2, rank_end=3,
            gold=3000, exp=6000, title="最强王者",
            avatar_frame="rank_2_3_frame"
        ),
        # 第4-10名
        LeaderboardReward(
            rank_start=4, rank_end=10,
            gold=2000, exp=4000, title="至尊王者",
    ...
    def update_player_data(
        ...
        logger.debug(
            f"Updated leaderboard data for player {player_id}",
            ...
            for period in LeaderboardPeriod:
                ...
                leaderboards.append({
                    ...
                    "updated_at": self._updated_at.get(key).isoformat() 
                        if self._updated_at.get(key) else None,
                })
