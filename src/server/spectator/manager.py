...
class SpectatorManager:
    ...
    def __init__(self) -> None:
        ...
        # 状态更新回调
        self._on_state_update: Callable[[str, SpectatorGameState], None] | None = None
        # 聊天回调
        self._on_chat: Callable[[SpectatorChat], None] | None = None
        # 计数器
    ...
    def create_spectatable_game(
        ...
        allowed_spectators: list[str] | None = None,
    ...
    def remove_spectatable_game(self, game_id: str) -> SpectatorData | None:
        """
        移除可观战对局
        ...
        logger.info(f"Removed spectatable game: {game_id}", extra={"game_id": game_id})

        return spectator_data

    def get_spectatable_game(self, game_id: str) -> SpectatorData | None:
        """
        获取可观战对局
    ...
    def leave_spectate(self, session_id: str) -> SpectatorSession | None:
        """
        离开观战
    ...
    def get_session(self, session_id: str) -> SpectatorSession | None:
        """
        获取观战会话
    ...
    def get_session_by_player(self, player_id: str) -> SpectatorSession | None:
        """
        根据玩家ID获取会话
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "games": {game_id: data.get_spectator_count() for game_id, data in self._games.items()},
        }
...
_spectator_manager: SpectatorManager | None = None
