...
class PlayerTalents:
    ...
    def get_available_talents(
        ...
        for talent in all_talents:
            if talent.talent_id not in self.unlocked_talents and talent.is_unlocked(
                self.unlocked_talents, self.talent_points
            ):
...
class TalentManager:
    ...
    def get_player_talents(self, player_id: str) -> PlayerTalents | None:
        """获取玩家天赋状态"""
