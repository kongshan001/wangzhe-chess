...
class EconomyManager:
    ...
    def calculate_interest(self, gold: Optional[int] = None) -> int:
        """
        计算利息收入
    ...
    def calculate_win_streak_bonus(self, streak: Optional[int] = None) -> int:
        """
        计算连胜奖励
    ...
    def calculate_lose_streak_bonus(self, streak: Optional[int] = None) -> int:
        """
        计算连败奖励
    ...
    def get_exp_for_next_level(self, level: Optional[int] = None) -> int:
        """
        获取升到下一级所需的总经验值
