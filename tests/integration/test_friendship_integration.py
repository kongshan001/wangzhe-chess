...
class TestFriendshipIntegration:
    ...
    def test_send_and_accept_friend_request(self, friendship_manager):
        ...
        # 更新玩家信息缓存
        friendship_manager.update_player_cache(player1, "玩家1", "avatar1.png", "gold", 10)
        friendship_manager.update_player_cache(player2, "玩家2", "avatar2.png", "silver", 5)
...
class TestPrivateMessageIntegration:
    ...
    def test_message_history_limit(self, friendship_manager):
        ...
        # 获取所有消息，应该被限制
        messages = friendship_manager.get_private_messages(player1, player2, limit=200)
...
class TestOnlineStatusIntegration:
    ...
    def test_player_in_game_status(self, friendship_manager):
        ...
        friendship_manager.set_player_status(
            player, FriendStatus.IN_GAME, game_info={"room_id": "room_001", "mode": "ranked"}
        )
...
class TestFriendshipSearchIntegration:
    ...
    def test_search_players(self, friendship_manager):
        """测试搜索玩家"""
        # 添加一些玩家到缓存
        friendship_manager.update_player_cache("player_001", "张三", "avatar1.png", "gold", 10)
        friendship_manager.update_player_cache("player_002", "李四", "avatar2.png", "silver", 5)
        friendship_manager.update_player_cache("player_003", "张三丰", "avatar3.png", "bronze", 0)
