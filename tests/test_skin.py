...
def sample_skin_rare() -> Skin:
    ...
    return Skin(
        ...
        effects=[
            SkinEffect(effect_type=SkinEffectType.MODEL, effect_id="rare_model", description="稀有造型"),
        ],
...
def sample_skin_epic() -> Skin:
    ...
    return Skin(
        ...
        effects=[
            SkinEffect(effect_type=SkinEffectType.MODEL, effect_id="epic_model", description="史诗造型"),
            SkinEffect(effect_type=SkinEffectType.SKILL, effect_id="epic_skill", description="技能特效"),
        ],
...
def sample_skin_legendary() -> Skin:
    ...
    return Skin(
        ...
        effects=[
            SkinEffect(effect_type=SkinEffectType.MODEL, effect_id="legendary_model", description="传说造型"),
            SkinEffect(effect_type=SkinEffectType.SKILL, effect_id="legendary_skill", description="全新技能特效"),
            SkinEffect(effect_type=SkinEffectType.SOUND, effect_id="legendary_sound", description="专属音效"),
            SkinEffect(effect_type=SkinEffectType.PARTICLE, effect_id="legendary_particle", description="专属粒子"),
        ],
