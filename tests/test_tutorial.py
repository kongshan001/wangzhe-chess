...
class TestTutorialModels(unittest.TestCase):
    ...
    def test_tutorial_step(self):
        ...
        step = TutorialStep(
            ...
            highlights=[TutorialHighlight(target="btn_start", tip_text="点击开始")],
        )
...
class TestTutorialManager(unittest.TestCase):
    ...
    def test_prerequisites(self):
        ...
        synergy_tutorial = next(
            (t for t in tutorials if t["tutorial_id"] == "tutorial_synergy"), None
        )
    ...
    def test_update_progress(self):
        ...
        # 完成第一步
        result = self.manager.update_progress("player_001", "tutorial_basic", "basic_1")
        ...
        # 完成第二步（最后一步）
        result = self.manager.update_progress("player_001", "tutorial_basic", "basic_2")
