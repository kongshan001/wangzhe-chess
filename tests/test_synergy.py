...
from shared.constants import PROFESSIONS, RACES
...
class TestCalculateActiveSynergies:
    ...
    def test_race_and_profession_together(self, synergy_manager: SynergyManager, create_hero):
        """测试种族和职业同时激活"""
        heroes = [
...
class TestGetSynergyBonuses:
    ...
    def test_no_bonuses_without_activation(self, synergy_manager: SynergyManager, create_hero):
        """测试未激活羁绊时无加成"""
        hero = create_hero(name="单人", race="人族", profession="战士")
...
class TestApplySynergyBonuses:
    ...
    def test_apply_multiple_bonuses(self, synergy_manager: SynergyManager, create_hero):
        """测试多个羁绊加成叠加"""
        heroes = [
    ...
    def test_apply_hp_flat_bonus(self, synergy_manager: SynergyManager, create_heroes_with_synergy):
        """测试固定生命值加成应用"""
...
class TestSynergyBoundaryConditions:
    ...
    def test_large_hero_count(self, synergy_manager: SynergyManager, create_heroes_with_synergy):
        """测试大量英雄计数"""
