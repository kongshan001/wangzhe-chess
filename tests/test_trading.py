...
from src.server.trading.manager import TradingManager, get_trading_manager
...
class TestTradingManager:
    ...
    def test_create_trade_request_success(self, manager):
        ...
        request, error = manager.create_trade_request(
            ...
            items=[
                {"item_type": "hero_shard", "item_id": "hero_001", "item_name": "亚瑟", "quantity": 50},
            ],
            message="交换碎片",
        )
    ...
    def test_create_trade_request_daily_limit(self, manager):
        ...
        for i in range(MAX_DAILY_TRADES):
            ...
            request, error = manager.create_trade_request(
                ...
                items=[
                    {"item_type": "hero_shard", "item_id": "hero_001", "item_name": "亚瑟", "quantity": 1},
                ],
            )
            if error:
